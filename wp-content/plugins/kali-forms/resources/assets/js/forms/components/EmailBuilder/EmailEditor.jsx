			...
			<Paper className={classes.formEmailsPlaceholder}>
				<Grid container direction="row" spacing={3}>
					<Grid item xs={12}>
						<FormControl>
							<InputLabel shrink>
								{KaliFormsObject.translations.formEmails.subject}
							</InputLabel>
							<BootstrapInput
								id="emailSubject"
				...
				<Grid container direction="row" spacing={3}>
					<Grid item xs={6}>
						<FormControl>
							<InputLabel shrink>
								{KaliFormsObject.translations.formEmails.fromName}
							</InputLabel>
							<BootstrapInput
								id="fromName"
					...
					<Grid item xs={6}>
						<FormControl>
							<InputLabel shrink>
								{KaliFormsObject.translations.formEmails.fromEmail}
							</InputLabel>
							<BootstrapInput
								id="fromName"
				...
				<Grid container direction="row" spacing={3}>
					<Grid item xs={6}>
						<FormControl>
							<InputLabel shrink>
								{KaliFormsObject.translations.formEmails.toEmail}
							</InputLabel>
							<BootstrapInput
					...
					<Grid item xs={6}>
						<FormControl>
							<InputLabel shrink>
								{KaliFormsObject.translations.formEmails.replyTo}
							</InputLabel>
							<BootstrapInput
				...
				<Grid container direction="row" spacing={3}>
					<Grid item xs={6}>
						<FormControl>
							<InputLabel shrink>
								{KaliFormsObject.translations.formEmails.ccEmail}
							</InputLabel>
							<BootstrapInput
								id="ccEmail"
					...
					<Grid item xs={6}>
						<FormControl>
							<InputLabel shrink>
								{KaliFormsObject.translations.formEmails.bccEmail}
							</InputLabel>
							<BootstrapInput
								id="bccEmail"
				...
				<Grid container direction="row" spacing={3}>
					<Grid item xs={12}>
						<FormControl>
							<InputLabel shrink>
								{KaliFormsObject.translations.formEmails.message}
							</InputLabel>
							<MUIRichTextEditor
				...
				<Grid container direction="row" spacing={3}>
					<Grid item xs={12}>
						<FormControl>
							<InputLabel shrink>
								{KaliFormsObject.translations.formEmails.emailAttachmentFilePaths}
							</InputLabel>
							<BootstrapInput
							...
							/>
							<FormHelperText>
								{KaliFormsObject.translations.formEmails.pathToYourWpIs + ' ' + KaliFormsObject.ABSPATH}
							</FormHelperText>
						</FormControl>
					</Grid>
				</Grid>
				<Grid container direction="row" spacing={3}>
					<Grid item xs={12}>
						<FormControl>
							<InputLabel shrink>
								{KaliFormsObject.translations.formEmails.emailAttachmentMediaIds}
							</InputLabel>
							<MediaSelector
				...
				<Box className={classes.emailEditorFooter}>
					...
					>
						...
						{KaliFormsObject.translations.formEmails.duplicateEmail}
					</Button>

					<Button variant="text"
						onClick={() => removeEmail()}>
						<Icon className="icon-remove" />
						{KaliFormsObject.translations.formEmails.removeEmail}
					</Button>
				</Box>
			</Paper>
		</React.Fragment >
