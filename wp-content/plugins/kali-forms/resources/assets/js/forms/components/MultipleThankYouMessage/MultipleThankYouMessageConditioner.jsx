	...
	return (
		<React.Fragment>
			<Grid item xs={12}>
				<FormControl>
					<InputLabel shrink>
						{KaliFormsObject.translations.formInfo.conditionName}
					</InputLabel>
					<BootstrapInput
			...
			<Grid item xs={3}>
				<FormControl>
					<InputLabel shrink>
						{KaliFormsObject.translations.formInfo.conditioner}
					</InputLabel>
					<Select
						multiple={false}
			...
			<Grid item xs={3}>
				<FormControl>
					<InputLabel shrink>
						{KaliFormsObject.translations.formInfo.operator}
					</InputLabel>
					<Select
						multiple={false}
						input={<BootstrapInput />}
					...
					>
						<MenuItem key="contains" value="contains">
							{KaliFormsObject.translations.formInfo.contains}
						</MenuItem>
						<MenuItem key="equal" value="equal">
							{KaliFormsObject.translations.formInfo.equal}
						</MenuItem>
						<MenuItem key="greater" value="greater">
							{KaliFormsObject.translations.formInfo.greater}
						</MenuItem>
						<MenuItem key="less" value="less">
							{KaliFormsObject.translations.formInfo.less}
						</MenuItem>
					</Select>
				</FormControl>
			</Grid>
			<If condition={conditioner !== false}>
				<Grid item xs={6}>
					<FormControl>
						<InputLabel shrink>
							{KaliFormsObject.translations.formInfo.value}
						</InputLabel>
						<Choose>
