		...
		<React.Fragment>
			<Grid container direction="row" spacing={3}>
				<Grid item xs={12}>
					<FormControl>
						<InputLabel shrink>
							{KaliFormsObject.translations.slack.slackName}
						</InputLabel>
						<BootstrapInput
			...
			<Grid container direction="row" spacing={3}>
				<Grid item xs={6}>
					<FormControl>
						<InputLabel shrink>
							{KaliFormsObject.translations.slack.type}
						</InputLabel>
						<Select
						...
						>
							<MenuItem value={'text'}>
								{KaliFormsObject.translations.slack.text}
							</MenuItem>
							<MenuItem value={'block'}>
								{KaliFormsObject.translations.slack.block}
							</MenuItem>
						</Select>
					</FormControl>
				</Grid>
				<Grid item xs={6}>
					<FormControl>
						<InputLabel shrink>
							{KaliFormsObject.translations.slack.where}
						</InputLabel>
						<Select
						...
						>
							<MenuItem value={'empty'}>{KaliFormsObject.translations.general.pleaseSelect}</MenuItem>
							{
			...
			<Grid container direction="row" spacing={3}>
				<Grid item xs={12}>
					<If condition={editedAction.type === 'block'}>
						<FormControl>
							<InputLabel shrink>
								{KaliFormsObject.translations.slack.fields}
							</InputLabel>
						</FormControl>
						{
					...
					<If condition={editedAction.type === 'text'}>
						<FormControl>
							<InputLabel shrink>
								{KaliFormsObject.translations.slack.message}
							</InputLabel>
							<BootstrapInput
