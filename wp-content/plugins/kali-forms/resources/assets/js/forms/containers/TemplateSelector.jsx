...
const TemplateSelector = observer((props) => {
	...
	const checkSMTP = () => {
		...
		store._CONFIRMATION_DIALOG_.setTitle(KaliFormsObject.translations.templateSelector.smtpAlertTitle);
		store._CONFIRMATION_DIALOG_.setMessage(KaliFormsObject.translations.templateSelector.smtpAlertMessage);
		store._CONFIRMATION_DIALOG_.setAdditionalButton({ action: notif.action, actionType: notif.actionType, buttonText: KaliFormsObject.translations.templateSelector.smtpButtonText });
		...
		<React.Fragment>
			<Container className={classes.paper}>
				<If condition={!selectedCard}>
					<Typography variant="h4" className={classes.title} >{KaliFormsObject.translations.templateSelector.title}</Typography>
					<Typography variant="subtitle1" className={classes.subtitle}>
						{KaliFormsObject.translations.templateSelector.description}
					</Typography>
					<Grid container direction="row" className={classes.toolbar}>
						<Grid item xs={6}>
							{/* <Button variant="text" className={classes.toolbarButtons}>
								<Icon className={'icon-refresh'} /> {KaliFormsObject.translations.templateSelector.refreshTemplates}
							</Button> */}
							<Button variant="text" className={classes.toolbarButtons} onClick={() => window.open('https://www.kaliforms.com/contact-us?utm_source=formBuilder&utm_campaign=userInterests&utm_medium=suggestNewTemplateButton&department=tech', '_blank')}>
								<Icon className={'icon-suggest'} /> {KaliFormsObject.translations.templateSelector.suggestTemplate}
							</Button>
						</Grid>
						<Grid item xs={6} style={{ textAlign: 'right' }}>
							{KaliFormsObject.translations.templateSelector.show}
							<Button
								variant="text"
							...
							>
								{KaliFormsObject.translations.templateSelector.all}
							</Button>
							<Button
								variant="text"
								className={classes.toolbarButtons}
							...
							>
								{KaliFormsObject.translations.templateSelector.free}
							</Button>
							<Button
								variant="text"
								className={classes.toolbarButtons}
							...
							>
								<Icon className={'icon-star'} /> {KaliFormsObject.translations.templateSelector.premium}
							</Button>
						</Grid>
					</Grid>
					<Grid container direction="row" spacing={4}>
						<Grid item xs={3}>
							<TemplateCard
								title={KaliFormsObject.translations.templateSelector.blank}
								description={KaliFormsObject.translations.templateSelector.blankDescription}
								blank={true}
								thumb={false}
							>
							</TemplateCard>
							...
							<FormControl component="fieldset" className={classes.formControl}>
								...
								<FormGroup row>
									...
									<FormControlLabel
										...
										label={KaliFormsObject.translations.templateSelector.formCalculator}
									/>
								</FormGroup>
							</FormControl>
